...
import me.beavermod.util.minecraft.PlayerUtils;
import me.beavermod.util.minecraft.entity.EntityManager;
import me.beavermod.util.minecraft.entity.SkyBlockEntity;
import me.beavermod.util.misc.Clock;
import me.beavermod.util.misc.MathUtil;
...
public class KillAura extends Module {
    ...
    public void attack() {
        try {
            if (target != null && attackTimer.hasReached(attackTime) && !cancelAttack && !mc.thePlayer.isUsingItem() && Reflection.curBlockDamageMP.getFloat(mc.playerController) == 0.0F) {
